...
Table: Samurai Level | Base Attack Bonus | Fort Save | Ref Save | Will Save | Special  
---|---|---|---|---|---  
...
**Subpages**
  ...
  * Cavalier Orders - d20pfsrd.com Publishing
  * Cavalier Orders - Dreamscarred Press
  * Cavalier Orders - Flaming Crab Games
  * Cavalier Orders - Louis Porter Jr. Design
  * Cavalier Orders - Paizo, Inc.
  * Cavalier Orders - Radiance House
  * Cavalier Orders - Rite Publishing
  * Cavalier Orders - The Knotty Works
  * Cavalier/Samurai Orders - Orphaned Bookworm Productions
...
At 3rd level, a samurai gains an unparalleled expertise with his chosen weapons. At 3rd level, the samurai selects either the katana, longbow, naginata, or wakizashi. The samurai can draw the selected weapon as a free action as if he had the Quick Draw feat.

In addition, whenever he threatens a critical hit with the selected weapon, he gains a +2 bonus on the confirmation roll. Finally, his samurai levels count as fighter levels and stack with any fighter levels he possesses for the purposes of meeting the prerequisites for feats that specifically select his chosen weapon, such as Weapon Specialization.
...
##### Alternate Banner Options

**Source** PPC:CoL

Some knights inspire and direct their allies with specialized tactics. A samurai can select one of the following battle standards upon gaining the banner class feature, and its benefits replace the normal benefits of the banner and greater banner class features. A battle standard functions as the banner or greater banner class feature except where otherwise noted. A samurai who replaces the banner or greater banner class feature via an archetype cannot select a battle standard.
...
1 | 4 | 7 | 10 | 13 | 16 | 19 | 2 | 8 | 15 | 6 | 12 | 18  
Paizo  
Brawling Blademaster |  |  |  | C |  |  |  |  |  |  |  | X |  |  |  |  |  |  |  | X | X | X |  |  |  |  |  |  | X |  |   
Ironbound Sword |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | X |  | X |  |  |  |  |  |  | X |  |   
Sword Saint |  |  |  |  |  |  |  |  |  |  |  | X |  |  |  |  |  |  |  |  | X | X |  |  |  |  |  |  | X |  |   
Sovereign Blade |  |  |  |  |  |  |  |  |  |  |  | X |  |  |  |  |  |  |  |  | X |  | X | X | X |  |  |  |  |  |   
Ward Speaker |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | X |  |  |  |  |  |  | X | C |  |  | X |   
Warrior Poet |  |  |  | C | C | C | C | C | C | C | C | X |  |  |  |  |  |  |  | X | X | X | X | X | X |  |  | X | X |  |   
Yojimbo |  |  |  |  |  |  |  |  |  |  |  | X |  |  |  |  |  |  |  | X | X |  |  |  |  |  |  |  |  |  |   
3rd Party Publishers  
Flaming Crab Games  
  
Katana Duelist |  |  |  | C |  |  |  |  |  |  |  | X |  |  |  |  |  |  |  |  | X | X |  |  |  |  |  |  | X |  |   
Rite Publishing  
Kuge | C | C | C | C | C | C | C | C | C | C | C | X |  |  |  |  |  |  | C | X | X | X |  |  |  |  |  |  |  |  |   
Nitōjutsu Sensei | C | C | C | C |  |  |  |  |  |  |  | X | X | X | X | X | X | X |  | C | X | X | X | X | X |  |  |  | X |  |   
Shogun |  |  |  |  |  |  |  |  |  |  |  | X |  |  |  |  |  |  | C | X |  |  | X | X |  |  |  |  |  |  |   
Tajiya |  | C |  |  | C | C | C | C | C | C | C | X |  |  |  |  |  |  | X | X | X | X |  |  |  |  |  |  | X |  |   
Yabusame |  |  |  | C | X | X | X | X | X | X | X |  |  |  |  |  |  |  |  | X |  | X | X | X | X |  | X | X | X |  |   
...
**Subpages**
  ...
  * Archetypes
    * Archetypes - Orphaned Bookworm Productions
      * Jito (Samurai Archetype)
      * Lord-Protector (Samurai)
    * Flaming Crab Games - Samurai Archetypes
      * Katana Duelist
    * Frog God Games Samurai Archetypes
      * Iaijutsu Master
    * Paizo, Inc. - Samurai Archetypes
      ...
      * Sword Saint
      * Yojimbo
    * Rite Publishing - Samurai Archetypes
      * Kuge
      * Nitōjutsu Sensei
      * Shogun
      * Tajiya
      * Yabusame
    * The Knotty-Works - Samurai Archetypes
      * Unearthed Samurai
  * Samurai Orders
    * 3rd Party Publishers
      * Samurai Orders – Name's Games
      * Samurai Orders - Rite Publishing
    * Paizo, Inc. - Samurai Orders
      * Order of the Songbird
      * Order of the Black Daimyo
