...
Table: Shaman Level | Base Attack Bonus | Fort Save | Ref Save | Will Save | Special | Spells per Day  
---|---|---|---|---|---|---  
...
**Subpages**
  ...
  * Ascension Games, LLC - Shaman Spirits
  * Jon Brazer Enterprises
  * Legendary Games - Shaman Spirits
  * Shaman Spirits - Necromancers of the Northwest
  * Shaman Spirits - Orphaned Bookworm Productions
...
Paizo  
Animist |  |  |  |  |  |  | C | X |  | X | X | X |  | X |  |  |  |  | X  
Deep Shaman | C |  |  |  | C | C |  | C | C | C | C | C | C | C | C |  |  |  |   
Draconic Shaman |  |  |  |  | X | X | C |  | X |  | X |  |  |  |  |  |  |  |   
Name Keeper | C |  |  |  |  | X |  |  |  |  |  |  |  |  |  | X | X | X |   
Overseer |  |  |  |  |  | C | C |  |  |  |  |  |  |  |  |  |  |  |   
Possessed Shaman |  |  |  |  |  |  | X | X |  |  |  |  |  |  |  |  | X |  |   
Primal Warden |  |  |  |  |  | C | C | C | X | X | C | X | C | C | C |  |  |  |   
Serendipity Shaman |  |  |  |  | C |  |  |  |  |  |  |  |  |  |  |  |  |  |   
Speaker For The Past | C |  |  |  |  | X |  |  |  |  |  |  |  |  |  | X | X | X |   
Spirit Warden | C |  |  |  |  |  | X | X |  |  | X |  |  |  |  |  |  |  |   
True Silvered Throne | C |  |  |  |  | X |  |  |  |  | X |  |  |  |  | X | X | X |   
Unsworn Shaman |  |  |  |  | X | C | C | X | X | X | X | X | X | X | X | C | X | X |   
Visionary |  |  |  |  |  |  | X |  |  |  |  |  |  |  |  | X | X |  |   
Witch Doctor |  |  |  |  |  |  |  |  | X | X | X | X |  |  |  |  |  |  |   
3rd Party Publishers  
Everyman Gaming, LLC  
Jiuweihu (Kitsune) |  |  |  |  |  | X | X |  |  |  |  |  |  |  |  |  |  |  |   
...
**Subpages**
  ...
  * 3rd Party - Shaman Spirits
    ...
    * Jon Brazer Enterprises
      * Dragon
    * Shaman Spirits - Orphaned Bookworm Productions
      * Artistry Shaman Spirit
      * Despair Shaman Spirit
      * Hope Shaman Spirit
    * Legendary Games - Shaman Spirits
      * Passion (Shaman Spirit)
      * Phoenix (Shaman Spirit)
      * Reaper (Shaman Spirit)
      * Whimsy Shaman Spirit
      * Aether (Shaman Spirit)
    * Ascension Games, LLC - Shaman Spirits
      * Darkness
      * Metal
  * Archetypes
    * Shaman Archetypes - Radiance House
      * Occult Shaman (Shaman Archetype)
    * Shaman Archetypes - d20pfsrd.com Publishing
      * Akashic Records (Shaman Spirit)
    * Shaman Archetypes - Samurai Sheepdog
      * Shaman of the Elements (Shaman Archetype)
    * Shaman Archetypes - Everyman Gaming, LLC
      * Jiuweihu (Kitsune)
    * Shaman Archetypes - Paizo, Inc.
      * Qahin (Shaman Archetype)
      * Crystal Tender
      * Grasping Vine
      * Primal Warden
      * Deep Shaman
