...
Table: Druid Level | Base Attack Bonus | Fort Save | Ref Save | Will Save | Special | Spells Per Day  
---|---|---|---|---|---|---  
...
3rd Party Publisher Druid Feats

The following 3rd Party Publisher feats are available to a druid character who meets the prerequisites.
...
_(Editor: Details on how animal companions work can found be here:**Animal Companions/Drake Companions**)  
_
