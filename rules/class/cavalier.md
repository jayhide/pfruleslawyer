...
Table: Cavalier Level | Base Attack Bonus | Fort Save | Ref Save | Will Save | Special  
---|---|---|---|---|---  
...
A Medium cavalier can select an axebeakPPC:WO, camelPPC:WO, elkPPC:WO, giant seahorsePPC:WO, giant tortoisePPC:WO, horse, giraffePPC:WO, or a zebraPZO1140 as a mount.

A Small cavalier can select an antelopePPC:WO, a capybaraPZO1140, giant weaselPPC:WO, lizard (giant gecko)PPC:WO, kangarooPPC:WO, pony, ramPPC:WO, reindeerPZO1140, stagPPC:WO, wolfPZO1140 or wolfdog as a mount but can also select a boarPZO1140 or a dogPZO1140 if he is at least 4th level. The GM might approve other animals as suitable mounts.
...
**Cavalier Orders**
  ...
  * Cavalier Orders - d20pfsrd.com Publishing
    * Order of Just Vengeance
  * Cavalier Orders - Dreamscarred Press
    * Forgesteed Rider (Forgeborn)
  ...
  * Cavalier Orders - Radiance House
    * Order of the Company (Cavalier Order)
    * Order of the Occult Eye (Cavalier Order)
    * Order of the Occult Eye
    * Order of the Scar
    * Pactsworn Knight
  * Cavalier Orders - Rite Publishing
    * Order of the Boar (Tengu)
  * Cavalier Orders - The Knotty Works
    * Order of Anger (Cavalier Order)
    * Order of Envy (Cavalier Order)
    * Order of Gluttony (Cavalier Order)
    * Order of Greed (Cavalier Order)
    * Order of Lust (Cavalier Order)
    * Order of Pride (Cavalier Order)
    * Order of Sloth (Cavalier Order)
  * Cavalier/Samurai Orders - Orphaned Bookworm Productions
    * Order of the Champion (Cavalier Order)
    * Order of the Beacon Cavalier/Samurai Order
    * Order or the Iron Fist Cavalier/Samurai Order
...
**Samurai Orders**
  ...
  * 3rd Party Publishers
    * Samurai Orders – Name's Games
      * Dragon Clan (Samurai Clan)
      * Phoenix Clan (Samurai Clan)
      * Scorpion Clan (Samurai Clan)
...
Some knights inspire and direct their allies with specialized tactics. A cavalier can select one of the following battle standards upon gaining the banner class feature, and its benefits replace the normal benefits of the banner and greater banner class features. A battle standard functions as the banner or greater banner class feature except where otherwise noted. A cavalier who replaces the banner or greater banner class feature via an archetype cannot select a battle standard, with the following exception: a standard bearer cavalier can select a battle standard at 1st level, and its effects increase as per the standard bearer’s banner.
