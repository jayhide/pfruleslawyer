...
Table: Magus Level | BAB | Fort Save | Ref Save | Will Save | Special | Spells per Day  
---|---|---|---|---|---|---  
...
**Does spell combat count as making a full attack action for the purpose ofhaste and other effects?**
...
**When using spell combat, can the weapon in my other hand be anunarmed strike or a natural weapon?**
...
_See FAQ for more information._
