...
### Modifiers
  ...
  * **Feats** If you have the Athletic feat, you get a +2 bonus on Climb checks. If you have 10 or more ranks in Climb, the bonus increases to +4.
  * **Size** Any creature of Tiny or smaller size should use its Dex modifier instead of its Str modifier for Climb and Swim checks (see FAQ).  
